...
console.log(`Getting servers ${serversArray.join(', ')} response process started.`);
...
function roundToNearestMinute(date = new Date()) {
    ...
    const result = new Date(Math.floor((date.getTime() - offset) / roundedToMinute) * roundedToMinute);
